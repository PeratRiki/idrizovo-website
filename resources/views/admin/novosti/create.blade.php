...
<div class="p-6" style="background:#f0f4fa; min-height:100vh;">
    ...
    <div style="display:flex; align-items:center; gap:12px; margin-bottom:24px;">
        ...
        <h1 style="font-size:1.75rem; font-weight:800; color:#1a2e4a;">+ Додај новост</h1>
    </div>
    ...
    <form method="POST" action="{{ route('admin.novosti.store') }}" enctype="multipart/form-data"
        ...
        <div>
            <label style="display:block; font-size:0.75rem; font-weight:700; color:#1a2e4a; margin-bottom:6px; text-transform:uppercase;">Категорија</label>
