<header>
    ...
    <nav class="bg-[#315b96] text-white px-4 md:px-20 py-4 flex justify-between items-center shadow-md relative">
        ...
        <div class="flex items-center space-x-2 md:space-x-4">
            ...
            <!-- ✅ ПОПРАВЕНО — button → a со route -->
            <a href="{{ route('appointments.index') }}" class="bg-sky-950 text-white px-4 md:px-6 py-2 rounded-md font-bold hover:bg-black transition text-sm md:text-base hidden md:block" data-mk="Закажи посета" data-sq="Cakto vizitë" data-en="Book a visit">Закажи посета</a>
