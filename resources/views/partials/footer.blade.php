...
<footer class="bg-gray-100 md:bg-transparent pt-4 md:pt-0">
    <div class="md:hidden mx-4 mb-4 bg-[#315b96] rounded-3xl flex flex-col items-center text-center text-white px-6 py-8 gap-3 shadow-xl">
        ...
        <!-- ✅ ПОПРАВЕНО -->
        <a href="{{ route('appointments.index') }}" class="mt-4 bg-[#0f172a] hover:bg-slate-800 text-white font-bold py-3 px-10 rounded-lg transition shadow-md">Закажи посета</a>
    </div>
    <div class="hidden md:block bg-[#315b96] border-t border-blue-800/30 py-8">
        <div class="max-w-7xl mx-auto px-6 flex justify-between items-center gap-6 lg:gap-10">
            ...
            <div class="flex-shrink-0">
                <!-- ✅ ПОПРАВЕНО -->
                <a href="{{ route('appointments.index') }}" class="inline-block bg-[#0f172a] hover:bg-slate-800 text-white text-sm py-2.5 px-6 rounded transition shadow-md whitespace-nowrap text-center">Закажи посета</a>
            </div>
        </div>
    </div>
</footer>