...
<div x-data="{ open: false }" class="relative">
    ...
    <div class="bg-gradient-to-b from-blue-100 to-blue-300 min-h-screen p-6 md:p-10 flex flex-col items-center">
        ...
        <div class="w-full max-w-2xl mb-8 flex items-center gap-4 mt-4">
            ...
            <h1 class="text-3xl font-bold text-slate-800 uppercase tracking-tight">Резба од дрво</h1>
        </div>
        ...
        <div class="w-full max-w-2xl grid grid-cols-2 gap-4 md:gap-6">
            ...
            <div class="bg-white/40 backdrop-blur-sm rounded-[1.5rem] overflow-hidden shadow-sm border border-white/20 flex flex-col">
                ...
                <div class="p-4 space-y-2 flex-grow flex flex-col text-center">
                    <h2 class="text-slate-800 font-bold text-sm">Lorem Ipsum</h2>
                    <p class="text-slate-600 text-[10px] leading-tight line-clamp-3">
                        Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                    </p>
                    <div class="flex-grow"></div>
                    <button @click="open = true" class="mt-2 bg-[#1a2b3c] text-white text-[10px] px-4 py-1.5 rounded-md hover:bg-black transition-colors w-fit mx-auto">
                        Резервирај
                    </button>
                </div>
            </div>
    ...
    <div x-show="open" 
        ...
        {{-- Сменети димензии: w-[450px] (ширина) и h-auto (висина по потреба) за правоаголен изглед --}}
        <div @click.away="open = false" 
            ...
            <div class="text-white">
                ...
                <p class="text-[17px] font-black italic mt-3 tracking-wide">Ви Благодариме.</p>
            </div>
        </div>
    </div>
