...
@section('content')
    ...
    <section class="pravilnik-section bg-white py-12 md:py-20">
        <div class="max-w-4xl mx-auto px-4 md:px-6 text-center">
            ...
            <a href="#" class="inline-block bg-[#101e3d] text-white font-bold px-8 md:px-12 py-3 md:py-4 rounded-xl hover:bg-[#1a2e5a] transition-all duration-300 shadow-md uppercase tracking-widest text-xs md:text-sm" data-mk="Превземи" data-sq="Shkarko" data-en="Download">Превземи</a>
        </div>
    </section>
