...
<body class="bg-gray-50 text-gray-900">
    ...
    <section class="hero-section relative h-[600px] flex items-center overflow-hidden">
        ...
        <div class="scroll-top-btn absolute bottom-10 right-10">
            ...
            <div class="mb-14">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div
                        ...
                        <p class="text-white/90 text-xs leading-relaxed mb-6 flex-grow text-justify"
                            data-mk="Врз основа на чл. 52 ст.1 од Законот за Административни службеници(Сл.весник на Република Македонија"
                            бр. 27/14, 199/14, 48/15, 154/15, 5/16, 80/16, 127/16, 142/16, 2/17, 16/17, 11/18 и
                            275/19).."
                    ...
                    <div
                        ...
                        <p class="text-white/90 text-xs leading-relaxed mb-6 flex-grow text-justify"
                            data-mk="Врз основа на чл.52 ст.1 од Законот за Административни службеници(Сл.весник на Република Македонија"
                            бр. 7/14, 199/14, 48/15, 154/15, 5/16, 80/16, 127/16, 142/16, 2/17, 16/17, 11/18 и
                            275/19).."
